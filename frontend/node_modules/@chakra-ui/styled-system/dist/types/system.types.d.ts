...
import type { BackgroundProps, BorderProps, ColorProps, EffectProps, FilterProps, FlexboxProps, GridProps, InteractivityProps, LayoutProps, ListProps, OtherProps, PositionProps, RingProps, SpaceProps, TextDecorationProps, TransformProps, TransitionProps, TypographyProps } from "@chakra-ui/styled-system/dist/types/config";
import { Pseudos } from "@chakra-ui/styled-system/dist/types/pseudos";
import { ResponsiveValue } from "@chakra-ui/styled-system/dist/types/utils/types";
